"""
Django settings for ticketinfra project.
...
SECRET_KEY = 'django-insecure-5pe=9@59*d&y1p*jnak2fd*fxs6f-qq$*yliroae%40o$s4i20'
...
WSGI_APPLICATION = 'ticketinfra.wsgi.application'
